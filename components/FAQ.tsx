...
const faqs = [
  ...
  { q: 'هل يمكنني إلغاء الحجز؟', a: 'نعم، يمكن إلغاء الحجز قبل 24 ساعة من موعد الخدمة دون أي رسوم إضافية.' },
  ...
  return (
    <section id="faq" style={{ padding: '96px 64px', background: 'white' }} className="sec-faq">
      <div style={{ textAlign: 'center', maxWidth: 640, margin: '0 auto 56px' }} className="rv">
        <span style={{ fontSize: '3rem', fontWeight: 900, color: 'var(--gold)', marginBottom: 12, display: 'block', fontFamily: 'PNU, Tajawal, sans-serif' }}>الأسئلة الشائعة</span>
