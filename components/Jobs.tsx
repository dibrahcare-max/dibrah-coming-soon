  ...
  return (
    <section id="jobs" style={{ padding: '96px 64px', background: 'white' }} className="sec-jobs">
      ...
      <div className="rv" style={{ maxWidth: 580, margin: '0 auto', textAlign: 'center', background: 'var(--bg)', borderRadius: 20, padding: 48, border: '1px solid var(--border)' }}>
        <h3 style={{ fontSize: 'clamp(1.5rem,3vw,2rem)', fontWeight: 900, color: 'var(--dark)', fontFamily: 'PNU, Tajawal, sans-serif', marginBottom: 12 }}>انضمي لركب المتميزات</h3>
        <p style={{ fontSize: '.95rem', color: 'white', lineHeight: 1.8, marginBottom: 28 }}>هل أنتِ شغوفة بترك أثرٍ يدوم؟ ضعي بصمتكِ في حياة الأسر السعودية وانضمِّي إلى ركب المتميزيات في (دِبرة). إبداعكِ هو الدِّبرة التي ننتظرها!</p>
