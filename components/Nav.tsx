    ...
    <>
      <nav style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a href="/book" style={{ fontSize: '.82rem', fontWeight: 700, color: 'var(--bg)', background: 'var(--dark)', padding: '8px 20px', borderRadius: 6, transition: 'all .2s' }} className="btn-book-nav">احجز الآن</a>
