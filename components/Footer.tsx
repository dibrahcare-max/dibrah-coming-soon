    ...
    <>
      ...
      <div style={{ background: 'var(--dark)', padding: '72px 64px', textAlign: 'center' }} className="sec-nl">
        ...
        <div style={{ display: 'flex', gap: 8, maxWidth: 440, margin: '0 auto' }} className="nl-form">
          ...
          <button style={{ background: '#F6F0D7', color: '#777C6D', border: 'none', borderRadius: 8, padding: '12px 24px', fontFamily: 'Tajawal, sans-serif', fontWeight: 800, fontSize: '.88rem', cursor: 'pointer', whiteSpace: 'nowrap' }}>إشتراك</button>
        </div>
      </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr 1fr 1.5fr', gap: 40, marginBottom: 40, paddingBottom: 40, borderBottom: '1px solid rgba(227,238,213,.08)' }} className="footer-top">
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 9 }}>
              {([['من نحن','/about'],['خدماتنا','/#services'],['الباقات','/#packages'],['الأسئلة الشائعة','/#faq'],['تواصل معنا','/#contact'],['سياسة الخصوصية','#'],['الشروط والأحكام','#']] as [string,string][]).map(([l,h]) => (
