...
const services = [
  ...
  { num: '07', cat: 'أطفال', title: 'برامج وأنشطة خارجية', desc: 'برامج ترفيهية وتعليمية خارجية للأطفال بإشراف كوادر مؤهلة، تنمّي مهاراتهم وتصنع ذكريات جميلة.' },
  { num: '08', cat: 'منزل', title: 'ربعيات / مدبرة منزل', desc: 'خدمة إدارة المنزل بأيدٍ سعودية موثوقة، تضمن نظافة وترتيباً وراحة كاملة لعائلتك.' },
  { num: '09', cat: 'صحة', title: 'مرافقات ومتابعة التغذية', desc: 'مرافقة صحية متخصصة تتابع التغذية والعلاج اليومي، وتضمن الالتزام بالبرامج الصحية للمريض أو كبير السن.' },
]
