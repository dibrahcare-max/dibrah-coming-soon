  ...
  return (
    <section id="about" style={{ padding: '96px 64px', background: 'var(--bg)' }} className="sec-about">
      ...
      <div style={{
        ...
        <div>
          <span style={{ fontSize: '3rem', fontWeight: 900, color: 'var(--gold)', marginBottom: 12, display: 'block', fontFamily: 'PNU, Tajawal, sans-serif' }}>من نحن</span>
          ...
          <div style={{ textAlign: 'right', marginTop: 28 }}>
            <a href="#packages" style={{ display: 'inline-block', background: 'var(--gold)', color: 'white', fontSize: '.9rem', fontWeight: 700, padding: '13px 36px', borderRadius: 8 }}>
              ابدأ مع دِبرة
            </a>
          </div>
        </div>
