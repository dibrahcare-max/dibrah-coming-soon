const articles = [
  { img: 'art1', date: 'نوفمبر 17, 2025', title: 'كيف تختار المرافق المناسب لمرافقة مريضك؟' },
  { img: 'art2', date: 'ديسمبر 5, 2025', title: '10 أسئلة يجب أن تسأليها قبل توظيف جليسة أطفال' },
  { img: 'art3', date: 'يناير 12, 2026', title: 'رعاية كبار السن: كيف نحفظ كرامتهم؟' },
]
