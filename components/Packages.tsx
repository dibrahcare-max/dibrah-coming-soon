const packages = [
  { name: 'الباقة اليومية', sub: 'يوم واحد', featured: false, rows: [{ h: '4 ساعات', v: '350 ﷼' }, { h: '8 ساعات', v: '600 ﷼' }] },
  { name: 'الباقة الأسبوعية', sub: 'خمسة أيام', featured: true, rows: [{ h: '4 ساعات', v: '2,000 ﷼' }, { h: '8 ساعات', v: '2,800 ﷼' }] },
  { name: 'الباقة الشهرية', sub: 'ستة وعشرون يوم', featured: false, rows: [{ h: '4 ساعات', v: '7,000 ﷼' }, { h: '8 ساعات', v: '14,000 ﷼' }] },
]
